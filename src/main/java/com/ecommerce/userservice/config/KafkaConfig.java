...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, UserRegisteredEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ecommerce.userservice.event,com.ecommerce.events");
    ...
    // ── Producer (for future use — e.g. publishing profile-updated events) ───
